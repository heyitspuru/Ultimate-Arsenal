        ...
        <TableBody>
          {perPattern.map((r) => (
            <TableRow key={`${r.pattern}-${round}`}>
              <TableCell className="text-caption">{r.pattern}</TableCell>
          ...
          <TableBody>
            {COMPLEXITY.dsOps.map((r) => (
              <TableRow key={r.structure}>
                <TableCell className="text-caption">{r.structure}</TableCell>
        ...
        <TableBody>
          {COMPLEXITY.growth.map((r) => (
            <TableRow key={r.bigO}>
              ...
              <TableCell className="text-caption">{r.feels}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>

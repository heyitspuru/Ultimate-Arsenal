...
export const DECISION_TREE: DecisionNode[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Range queries WITH updates (sum/min, count smaller)", slug: "range-queries" },
      { label: "Max/min of every size-k window", slug: "monotonic-deque" },
    ],
  },
  {
    id: "ll",
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Shortest path between EVERY pair (small n)", slug: "floyd-warshall" },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "n ≤ 20 — DP over subsets (bitmask states)", slug: "bitmask-dp" },

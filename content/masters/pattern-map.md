...
| XIII. Array / Matrix Manipulation | [Prefix Sum](../patterns/04-prefix-sum.md) · [Cyclic Sort](../patterns/10-cyclic-sort.md) |
...
Covered now via Sprint 4: weighted shortest path (Dijkstra / Bellman-Ford), MST, SCC & bridges (Tarjan), KMP string matching, Interval DP, and LRU/LFU design.

A future **Sprint 5** could add: **Floyd-Warshall / A\*, Aho-Corasick multi-pattern matching, suffix arrays/automata, Segment Tree & Fenwick (BIT), and heavy Bitmask DP.** Say the word and I'll add pages for any of them.
